      ...
      <div className="container-page py-20 md:py-28 grid grid-cols-1 md:grid-cols-12 gap-12">
        <div className="md:col-span-5">
          ...
          <p className="mt-6 max-w-md text-sm opacity-70 leading-relaxed">
            Adelaide's independent residential agency since 1978. A small, senior team selling and
            managing distinguished properties across metropolitan South Australia.
          </p>
        ...
        <div className="md:col-span-3">
          ...
          <address className="not-italic text-sm space-y-2 opacity-90">
            ...
            <div className="pt-3">
              <a href="tel:+61883703211" className="block hover:text-[var(--ringgreen)]">
                (08) 8370 3211
              </a>
              <a href="mailto:ring@ring-sa.com.au" className="block hover:text-[var(--ringgreen)]">
                ring@ring-sa.com.au
              </a>
            </div>
          </address>
