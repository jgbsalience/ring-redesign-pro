...
export const Route = createFileRoute("/trust-account")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Ring Real Estate trust account details and statutory information.",
      },
    ],
    ...
    <div className="bg-background text-foreground">
      ...
      <section className="pt-28 md:pt-36 container-page pb-24 md:pb-32 max-w-3xl">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          <p>
            Ring Real Estate Pty Ltd holds all client monies in a dedicated trust account in
            accordance with the <em>Land Agents Act 1994</em> (SA) and the{" "}
            <em>Land Agents (Exemptions) Regulations</em>.
          </p>
          ...
          <dl className="space-y-3">
            ...
            <div>
              ...
              <dd className="mt-1 text-foreground">
                140 Shepherds Hill Road, Bellevue Heights SA 5050
              </dd>
            </div>
          </dl>

          <p>
            For any questions regarding trust account transactions, please contact our office
            directly.
          </p>
          ...
          <p className="pt-6 border-t border-border text-xs">
            ...
            full statutory trust account disclosure and update the RLA number before going live.
          </p>
        </div>
      </section>
      <Footer />
