    ...
    <div className="bg-background text-foreground">
      ...
      <section className="pt-28 md:pt-36 container-page pb-24 md:pb-32 max-w-3xl">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          <p>
            Ring Real Estate takes all complaints seriously. If you are dissatisfied with any aspect
            of our service, we encourage you to contact us directly in the first instance.
          </p>

          <h2 className="font-serif text-2xl text-foreground mt-10">
            Step 1 — Contact us directly
          </h2>
          <p>
            Speak with or write to the principal agent. We aim to resolve all complaints within 5
            business days.
          </p>
          <address className="not-italic space-y-1">
            <div>
              <a href="tel:+61883703211" className="text-foreground underline underline-offset-2">
                (08) 8370 3211
              </a>
            </div>
            <div>
          ...
          <h2 className="font-serif text-2xl text-foreground mt-10">
            Step 2 — Consumer and Business Services
          </h2>
          <p>
            If your complaint is not resolved to your satisfaction, you may contact Consumer and
            Business Services (CBS) South Australia:
          </p>
          ...
          <p className="pt-6 border-t border-border text-xs">
            ...
            your full complaints procedure before going live.
          </p>
        </div>
      </section>
      <Footer />
