...
const SELL_SLIDES = listings.filter((l) => l.status === "sold" && l.hero).slice(0, 6);
  ...
  head: () => ({
    meta: [
      { title: "Sell with Ring — Adelaide's most considered campaigns" },
      {
        name: "description",
        content:
          "Three deliberate methods of sale, one promise: integrity. Request a confidential appraisal.",
      },
      { property: "og:title", content: "Sell with Ring Real Estate" },
      {
        property: "og:description",
        content: "Three deliberate methods of sale. One promise: integrity.",
      },
    ],
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <BannerHero
        ...
        title={
          <>
            Welcome to <span className="italic font-light">Ring Real Estate</span>
          </>
        }
          ...
          {[
            {
              n: "01",
              t: "Set to Sell",
              d: "A defined campaign window with a closing date. Buyers move with intent because there is a finish line.",
              w: "Best for distinctive homes where price discovery matters.",
            },
            {
              n: "02",
              t: "Auction",
              d: "Public competition on the day. Transparent, decisive, often the strongest result.",
              w: "Best for in-demand suburbs and unique properties.",
            },
            {
              n: "03",
              t: "Private Treaty",
              d: "Quiet negotiation on a published price. Considered, discreet, exact.",
              w: "Best for owners who value privacy above velocity.",
            },
          ].map((m) => (
